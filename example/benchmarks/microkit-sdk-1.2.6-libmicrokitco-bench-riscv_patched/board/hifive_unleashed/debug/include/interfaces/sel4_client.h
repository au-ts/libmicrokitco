...
assert_size_correct(seL4_RISCV_VCPU, 8);
...
struct seL4_RISCV_VCPU_ReadRegs {
	int error;
	seL4_Word value;
};
typedef struct seL4_RISCV_VCPU_ReadRegs seL4_RISCV_VCPU_ReadRegs_t;
...
/**
 * @xmlonly <manual name="Set TCB" label="riscv_vcpu_set_tcb"/> @endxmlonly
 ...
 */
LIBSEL4_INLINE seL4_Error
seL4_RISCV_VCPU_SetTCB(seL4_RISCV_VCPU _service, seL4_TCB tcb)
{
	seL4_Error result;
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(RISCVVCPUSetTCB, 0, 1, 0);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
	seL4_Word mr2;
...
#if defined(CONFIG_RISCV_HYPERVISOR_SUPPORT)
/**
 * @xmlonly <manual name="Read Registers" label="riscv_vcpu_read_registers"/> @endxmlonly
 * @brief @xmlonly Read a virtual CPU register @endxmlonly
 * @param[in] _service 
 * @param[in] field Register to read from a VCPU 
 * @return @xmlonly @endxmlonly
 */
LIBSEL4_INLINE seL4_RISCV_VCPU_ReadRegs_t
seL4_RISCV_VCPU_ReadRegs(seL4_RISCV_VCPU _service, seL4_Word field)
{
	seL4_RISCV_VCPU_ReadRegs_t result;
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(RISCVVCPUReadReg, 0, 0, 1);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
	seL4_Word mr2;
...
#if defined(CONFIG_RISCV_HYPERVISOR_SUPPORT)
/**
 * @xmlonly <manual name="Write Registers" label="riscv_vcpu_write_registers"/> @endxmlonly
 ...
 */
LIBSEL4_INLINE seL4_Error
seL4_RISCV_VCPU_WriteRegs(seL4_RISCV_VCPU _service, seL4_Word field, seL4_Word value)
{
	seL4_Error result;
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(RISCVVCPUWriteReg, 0, 0, 2);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
	seL4_Word mr2;

 ...
 * @brief @xmlonly Tell the microkernel to make the real SMC call. @endxmlonly
 * 
 * @xmlonly
 ...
 * @return @xmlonly <errorenumdesc/> @endxmlonly
 * @retval seL4_DeleteFirst The  @xmlonly <texttt text="index"/> @endxmlonly  is in use. 
 * @retval seL4_IllegalOperation The  @xmlonly <texttt text="_service"/> @endxmlonly  is a CPtr to a capability of the wrong type. 
 * @retval seL4_InvalidCapability The  @xmlonly <texttt text="_service"/> @endxmlonly  is a CPtr to a capability of the wrong type. 
...
/**
 * @xmlonly <manual name="GetSID" label="arm_sid_controlgetsid"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="GetFault" label="arm_sid_controlgetfault"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="ClearFault" label="arm_sid_controlclearfault"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="BindCB" label="arm_sid_bindcb"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="UnbindCB" label="arm_sid_unbindcb"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="GetCB" label="arm_cb_controlgetcb"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="TLBInvalidateAll" label="arm_cb_controltlbinvalidate"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="AssignVspace" label="arm_cb_assignvspace"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="UnassignVspace" label="arm_cb_unassignvspace"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="TLBInvalidate" label="arm_cb_tlbinvalidate"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="CBGetFault" label="arm_cb_getfault"/> @endxmlonly
...
#if defined(CONFIG_ARM_SMMU)
/**
 * @xmlonly <manual name="CBClearFault" label="arm_cb_clearfault"/> @endxmlonly
